...
import com.projeto.integrado.dto.ProjetoIdNomeDTO;
...
public class ProjetoService {
	...
	public List<ProjetoIdNomeDTO> getProjetoIdNome() {
		List<Projeto> projetos = projetoRepository.findAll();
		List<ProjetoIdNomeDTO> listaProjetoIdNomeDTOs = new ArrayList<>();
		for(Projeto projeto : projetos) {
			ProjetoIdNomeDTO projetoIdNomeDTO = new ProjetoIdNomeDTO();
			projetoIdNomeDTO.setProjetoId(projeto.getProjetoId());
			projetoIdNomeDTO.setProjetoNome(projeto.getProjetoNome());
			listaProjetoIdNomeDTOs.add(projetoIdNomeDTO);
		}
		return listaProjetoIdNomeDTOs;
	}
