...
import com.projeto.integrado.dto.RecursoIdNomeDTO;
...
public class RecursoService {
	...
	public List<RecursoIdNomeDTO> getProjetoIdNome() {
		List<Recurso> recursos = recursoRepository.findAll();
		List<RecursoIdNomeDTO> listaRecursoIdNomeDTOs = new ArrayList<>();
		for(Recurso recurso : recursos) {
			RecursoIdNomeDTO recursoIdNomeDTO = new RecursoIdNomeDTO();
			recursoIdNomeDTO.setRecursoId(recurso.getRecursoId());
			recursoIdNomeDTO.setRecursoNome(recurso.getRecursoNome());
			listaRecursoIdNomeDTOs.add(recursoIdNomeDTO);
		}
		return listaRecursoIdNomeDTOs;
	}
